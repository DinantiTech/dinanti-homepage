...
export default function CardBlog(props: TypeProps) {
    return (
        <Link href={props.link}>
            <div className='rounded-xl shadow-md shadow-[#D7DCBE] flex flex-col items-center justify-start overflow-hidden bg-white hover:cursor-pointer hover:shadow-lg gap-y-3 pb-3'>
